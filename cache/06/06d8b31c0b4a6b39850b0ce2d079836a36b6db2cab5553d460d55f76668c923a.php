...
/* admin/forms.twig */
class __TwigTemplate_6a9797f463ed2d63beb239efab861ec2e234c73feb4df399bdb01b6eb73bd64a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<div class=\"metabox-holder\">
  {% for section in sections %}
    <div id=\"{{ section.id }}\" class=\"js-dits-section\" style=\"display: none;\">

      {% if section.callback %}
        {{ section.do_settings_sections|raw }}
      {% else %}
        <form method=\"post\" action=\"options.php\">
          {{ section.settings_fields|raw }}
          {{ section.do_settings_sections|raw }}
          {{ section.submit|raw }}
        </form>
      {% endif %}
...
", "admin/forms.twig", "/Users/themkvz/Local Sites/plugins/app/public/wp-content/plugins/dits-plugin/templates/admin/forms.twig");
    }
}
